        ...
        <aside id="layout-menu" className="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul className="menu-inner py-1">
            ...
            <li className="menu-header small text-uppercase">
                <span className="menu-header-text">Quests Management</span>
            </li>
            <li className="menu-item">
                <a href="/management" className="menu-link">
                    <i className="menu-icon tf-icons bx bx-collection"></i>
                    <div data-i18n="Analytics">Quests</div>
                </a>
            </li>
            <li className="menu-item">
                <a href="#" className="menu-link">
                    <i className="menu-icon tf-icons bx bx-task"></i>
                    <div data-i18n="Analytics">Review submissions</div>
                </a>
            </li>
            {/* User management */}
            <li className="menu-header small text-uppercase">
                <span className="menu-header-text">Users Management</span>
            </li>
            <li className="menu-item">
                <a href="#" className="menu-link">
            ...
            {/* Account management */}
            <li className="menu-header small text-uppercase">
                <span className="menu-header-text">Account Management</span>
            </li>
            <li className="menu-item">
                <a href="#" className="menu-link">
